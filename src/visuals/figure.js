 ...
 *
 * There was a third member — the recurring FORM (proposal B2), twice: a moth
 * silhouette removed by D28, then a grown rule removed by D42. Both times the
 * removal was the same verdict, that a persistent figure hanging in front of
 * the camera reads as an object placed in the frame rather than as part of the
 * world. The slot is empty on purpose; see design_decisions.md before refilling
 * it a third time.
 */
